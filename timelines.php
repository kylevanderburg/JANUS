...
echo "<div class=\"hh text-center\"><h1>Timelines</h1></div>";
// $hr->toolbar();
echo "<div class=\"btn-toolbar\" role=\"toolbar\" aria-label=\"Liszt Toolbar\"><div class=\"btn-group me-2\" role=\"group\" aria-label=\"Deliveries\"><a href=\"/timelines/\" class=\"btn btn-outline-liszt btn-lg active\" title=\"Index\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\"><i class=\"fa-light fa-square-list\"></i></a><a href=\"/timelines/new/\" class=\"btn btn-outline-liszt btn-lg\" title=\"New\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\"><i class=\"fa-light fa-plus\"></i></a></div></div><br />";
...
switch ($action){
			...
			<div class="tab-content">
				...
				<br />
					<table class="table table-hover">
						...
						<tr><td><?php $opt['classes']="";$hr->textarea("description","Description (Markdown)",$opt);?></td></tr>
						<script>
						var simplemde = new SimpleMDE({ element: document.getElementById("timeline-description-field") });
						</script> 
						<?php if($action!="new"){
							echo "<tr><td>".$hr->row['guid']."</td></tr>";
						}?>
	...
	default:
		...
		$hr->listIndexWrapper("","ORDER BY `name` ASC",1,"50","",$hammer->getHD());
