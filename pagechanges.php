...
echo "<div class=\"hh text-center\"><h1>Page Changes</h1></div>";
// $hr->toolbar();
echo "<div class=\"btn-toolbar\" role=\"toolbar\" aria-label=\"Liszt Toolbar\"><div class=\"btn-group me-2\" role=\"group\" aria-label=\"Deliveries\"><a href=\"/pagechanges/\" class=\"btn btn-outline-liszt btn-lg active\" title=\"Index\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\"><i class=\"fa-light fa-square-list\"></i></a><a href=\"/pagechanges/new/\" class=\"btn btn-outline-liszt btn-lg\" title=\"New\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\"><i class=\"fa-light fa-plus\"></i></a></div></div><br />";
...
switch ($action){
	...
	case "write":
			...
			<div class="tab-content">
				...
				<br />
					<table class="table table-hover">
						...
						<tr><td><?php $hr->textinput("url","URL");?></td></tr>
						<tr><td><?php $hr->textinput("contenthash","Content Hash");?></td></tr>
					</table>
		...
		<div class="btn-group btn-group-lg">
		  ...
		  <?php echo $hr->deleteButton($hr->row['id'],$hr->row['url']); ?>
		</div>
		</div>
		</form>
