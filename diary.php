...
echo "<div class=\"hh text-center\"><h1>Diary</h1></div>";
// $hr->toolbar();
echo "<div class=\"btn-toolbar\" role=\"toolbar\" aria-label=\"Liszt Toolbar\"><div class=\"btn-group me-2\" role=\"group\" aria-label=\"Deliveries\"><a href=\"/diary/\" class=\"btn btn-outline-liszt btn-lg active\" title=\"Index\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\"><i class=\"fa-light fa-square-list\"></i></a><a href=\"/diary/new/\" class=\"btn btn-outline-liszt btn-lg\" title=\"New\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\"><i class=\"fa-light fa-plus\"></i></a></div></div><br />";
...
switch ($action){
	...
	case "write":
		...
		if($action=="modify"){$hr->id=$hammer->location[3];}
				...
				<br />
					<table class="table table-hover">
						...
						<tr><td>
							...
							<label for="<?php echo $hr->page;?>-person">Name</label>
							<input type="hidden" name="person" value="" />
							<select id="<?php echo $hr->page;?>-person" name="person" class="form-control lz-field">
								<?php
								foreach($hr->personcodes as $k=>$v)
								{
									echo "<option value=\"" . $k . "\""; if($hr->row['person']==$k){echo " selected";} echo ">" . $v . "</option>";
								}
								?>
								</select>
							</div>
