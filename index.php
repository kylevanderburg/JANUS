...
//Get the token out of storage
	if(typeof(Storage) !== "undefined") {
		if(localStorage.getItem("kvtoken")===null){
			window.location = '/sys-login.php';
		}else{
			
		}
	} else {alert('Vanderburg.app cannot be configured on this device.');}
</script>
<?php
...
$hammer->visitor = unserialize(base64_decode($_COOKIE['HammerCookie']));
$title = "Vanderburg.app";
// $hammer->debug();
// $includes = "
// <link rel=\"stylesheet\" href=\"//noteforge.com/assets/ntfg-bootstrap.css?v=".$hammer->getHT('timestamp')."\" type=\"text/css\" /><link rel=\"shortcut icon\" href=\"//noteforge.com/favicon.ico\"/>";
$hammer->head($title,"<link rel=\"shortcut icon\" href=\"/Wheel2.svg\"/>");
?>
...
<div class="container">
<p><center><a href="/"><img src="//vanderburg.app/Wheel2.svg" alt="Vanderburg.app" width="50" class="mt-3" /></a><br />
	<span style="font: 15px Lexend Zetta, sans-serif;"><a href="/" style="color:#000;">JANUS</a></span></center></p>
	<?php 
	if(empty($hammer->location[0])){
		?>
		<h1><a href="diary/">Diary</a></h1>
		<h1><a href="status/">Statuses</a></h1>
		<h1><a href="pagechanges/">Page Changes</a></h1>
		<hr>
		<h1><a href="quotes/">Quotes</a></h1>
		<h1><a href="sources/">Sources</a></h1>
		<hr>
		<h1><a href="timelines/">Timelines</a></h1>
		<h1><a href="timeline-events/">Timeline Events</a></h1>
		<?php
	}else{
		include $hammer->location[0].".php";
	}		?>
</div><!--container-fluid-->
